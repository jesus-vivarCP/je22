		...
		<tbody>
			...
			<tr>
				...
				<td><button type="button" class="btn btn-primary"
						...
						href="editbranch.jsp?branchId=<%=a.getBranchId()%>">Update
						Branch</button></td>
				<td>
					<form action="updateLoansTable">
						<button type="button" class="btn btn-success"
							onclick="updateLoansTable(<%=a.getBranchId()%>)">view
							Copies/Loans</button>
					</form>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<button type="button" class="btn btn-success" data-toggle="modal"
						...
						href="addcopies.jsp?branchId=<%=branchId%>&bookId=<%=book.getBookId()%>">Add
						Copies +</button>
