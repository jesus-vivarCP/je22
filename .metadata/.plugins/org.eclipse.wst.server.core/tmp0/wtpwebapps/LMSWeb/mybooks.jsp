...
${message}
<script>
	function updateLoansTable(branchId,cardNo){
		$.ajax({
			url: "updateCheckoutTable",
			data:{
				branchId: branchId,
				cardNo: cardNo,
			}
...
<div class="container">
	...
	<nav aria-label="Page navigation">
		<ul class="pagination">
			...
			%>
			<li><a href="pageborrower?pageNo=<%=i%>&cardNo=<%=cardNo%>"><%=i%></a></li>
			<%
				}
			%>
	...
	<table class="table" id="branchsTable">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<form action="updateCheckoutTable">
						<button type="button" class="btn btn-success"
							onclick="updateLoansTable(<%=a.getBranchId()%>,<%=cardNo%>)">View
							book</button>
					</form>
				</td>
			</tr>
