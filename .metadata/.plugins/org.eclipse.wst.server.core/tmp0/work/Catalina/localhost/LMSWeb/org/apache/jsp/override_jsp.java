 ...
 * Generated at: 2017-05-02 19:11:23 UTC
...
public final class override_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.gcit.lms.entity.BookLoans");
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if (loans == null)
      ...
      out.write("\n");
      out.write("<script>\n");
      out.write("\tfunction searchBorrowers(cardNo){\n");
      out.write("\t\t$.ajax({\n");
      out.write("\t\t\turl: \"getLoans\",\n");
      out.write("\t\t\tdata:{\n");
      out.write("\t\t\t\tcardNo: cardNo,\n");
      out.write("\t\t\t}\n");
      out.write("\t\t}).done(function (data){\n");
      out.write("\t\t\t$('#loansTable').html(data)\n");
      out.write("\t\t})\n");
      out.write("\t}\n");
      out.write("</script>\n");
      out.write("<div class=\"container\">\n");
      ...
      out.write("\t\t\t<h1>List of Borrowers in LMS</h1>\n");
      out.write("\t\t</div>\n");
      out.write("\t\t<!--<div class=\"input-group\">\n");
      out.write("      \n");
      out.write("      <form action=\"searchBorrowers\">\n");
      out.write("\t     <input type=\"text\" class=\"form-control\" name=\"searchString\" id=\"searchString\" placeholder=\"Search for...\" oninput=\"searchBorrowers()\">\n");
      out.write("      </form> -->\n");
      out.write("\t</div>\n");
      ...
      out.write("\n");
      out.write("\t\t\t<li><a href=\"pageOverride?pageNo=");
      out.print(i);
      out.write('"');
      out.write('>');
      out.print(i);
      ...
      out.write("\t</nav>\n");
      out.write("\t<div>\n");
      out.write("\t\t<table class=\"table\" id=\"borrowersTable\">\n");
      out.write("\t\t\t<thead>\n");
      out.write("\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t<th>cardNo</th>\n");
      out.write("\t\t\t\t\t<th>Borrower Name</th>\n");
      out.write("\t\t\t\t\t<th>Edit</th>\n");
      out.write("\t\t\t\t\t<th>Delete</th>\n");
      out.write("\t\t\t\t\t<th>View Loans</th>\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\t\t\t</thead>\n");
      out.write("\t\t\t<tbody>\n");
      out.write("\t\t\t\t");
      ...
      out.write("\n");
      out.write("\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t<!-- borrowers.indexOf(a) + 1 -->\n");
      out.write("\t\t\t\t\t<td>");
      out.print(a.getCardNo());
      out.write("</td>\n");
      out.write("\t\t\t\t\t<td>");
      out.print(a.getName());
      out.write("</td>\n");
      out.write("\t\t\t\t\t<td><button type=\"button\" class=\"btn btn-primary\"\n");
      out.write("\t\t\t\t\t\t\tdata-toggle=\"modal\" data-target=\"#editBorrowerModal\"\n");
      out.write("\t\t\t\t\t\t\thref=\"editborrower.jsp?cardNo=");
      out.print(a.getCardNo());
      out.write("\">Update</button></td>\n");
      out.write("\t\t\t\t\t<td><button type=\"button\" class=\"btn btn-danger\">\n");
      out.write("\t\t\t\t\t\t\t<a href=\"deleteBorrower?cardNo=");
      out.print(a.getCardNo());
      out.write("\">Delete</a>\n");
      out.write("\t\t\t\t\t\t</button></td>\n");
      out.write("\t\t\t\t\t<td>\n");
      ...
      out.write("\t\t\t\t\t\t\t\tonclick=\"searchBorrowers(");
      out.print(a.getCardNo());
      out.write(")\">View\n");
      out.write("\t\t\t\t\t\t\t\tLoans</button>\n");
      out.write("\t\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\t\t\t\t");
      ...
      out.write("\t\t\t</tbody>\n");
      out.write("\t\t</table>\n");
      out.write("\t\t<table class=\"table\" id=\"loansTable\">\n");
      out.write("\t\t\t<thead>\n");
      out.write("\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t<th>cardNo</th>\n");
      out.write("\t\t\t\t\t<th>bookId</th>\n");
      out.write("\t\t\t\t\t<th>branchId</th>\n");
      out.write("\t\t\t\t\t<th>dateOut</th>\n");
      out.write("\t\t\t\t\t<th>dateIn</th>\n");
      out.write("\t\t\t\t\t<th>dueDate</th>\n");
      out.write("\t\t\t\t\t<th>Extend due date</th>\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\t\t\t</thead>\n");
      out.write("\t\t\t<tbody>\n");
      out.write("\t\t\t\t");
      ...
      out.write("\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t<td>");
      out.print(loan.getCardNo());
      out.write("</td>\n");
      out.write("\t\t\t\t\t<td>");
      out.print(loan.getBookId());
      out.write("</td>\n");
      out.write("\t\t\t\t\t<td>");
      out.print(loan.getBranchId());
      out.write("</td>\n");
      out.write("\t\t\t\t\t<td>");
      out.print(loan.getDateOut());
      out.write("</td>\n");
      out.write("\t\t\t\t\t<td>");
      out.print(loan.getDateIn());
      out.write("</td>\n");
      out.write("\t\t\t\t\t<td>");
      out.print(loan.getDueDate());
      out.write("</td>\n");
      out.write("\t\t\t\t\t<td><button type=\"button\" class=\"btn btn-success\">\n");
      out.write("\t\t\t\t\t\t\t<a href=\"extendLoan?cardNo=");
      out.print(loan.getCardNo());
      out.write("&loc=");
      out.print(idx);
      out.write("\">Extend\n");
      out.write("\t\t\t\t\t\t\t\tdue date</a>\n");
      out.write("\t\t\t\t\t\t</button></td>\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t\tdata-target=\"#editBorrowerModal\" href=\"addborrower.jsp\">Add\n");
      out.write("\t\t\t\t\t\t\tBorrower</button>\n");
      out.write("\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\t\t\t</tbody>\n");
      out.write("\t\t</table>\n");
      out.write("\t</div>\n");
      out.write("</div>\n");
      out.write("\t<div class=\"modal fade bs-example-modal-lg\" id=\"editBorrowerModal\"\n");
